...
<%
	RecproBoard rpb = (RecproBoard)request.getAttribute("rb");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>상품 제안 - <%= rpb.getRecpro_title() %></title>
<style type="text/css">
/* 	section */
.section-area {
	width: 1000px;
...
<body>
	...
	<div class="outline">
		...
		<section>
			<div class="outer">
				...
				<br>
				<div class="tableArea">
					<form action="rpbUpdateForm.re" id="detailForm"
						...
						<table class="board_list">
							...
							<tbody>
								...
								<tr>
									...
									<td class="sel_op">
										<input type="hidden" name = "no" value ="<%= rpb.getRecpro_no() %>">
										<%= rpb.getRecpro_title() %>
									</td>
								</tr>
								<tr>
									<th class="input_txt">작성자</th>
									<td class="sel_op"><%= rpb.getRecpro_writer() %></td>
								</tr>

								<tr>
									<th class="input_txt">작성일</th>
									<td class="sel_op"><%= rpb.getRecpro_date() %></td>
								</tr>
								<tr>
											...
											<div class="inner_qnaNotice">
												<div class="notice_qna">
													...
													<textarea name="content"
														...
														cols="20" rows="6" readonly="readonly" ><%= rpb.getRecpro_content() %></textarea>
												</div>
											</div>
										</div>
									</td>
						...
						<div align="center">
							<% if (loginUser != null && loginUser.getMemberid().equals(rpb.getRecpro_writer())) { %>
	...
	<script>
		function deleteNotice(){
			...
			if(bool){
				location.href="<%=request.getContextPath()%>/delete.rpb?rpb="+<%=rpb.getRecpro_no()%>;
			}
		}
	</script>
