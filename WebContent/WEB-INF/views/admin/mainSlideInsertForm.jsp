...
<body>
	...
	<div class="outer" align="center">
		...
		<form action="<%= request.getContextPath() %>/mainBannerInsert.ad" method="post" encType="multipart/form-data"><!-- 파일올리는 거기 때문에 -->
					...
					<tr>
						...
						<td>
							<div id="contentImgArea1">
								<img id="contentImg1" width="800" height="350"> 
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div id="contentImgArea2">
								<img id="contentImg2" width="800" height="350"> 
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div id="contentImgArea3">
								<img id="contentImg3" width="800" height="350"> 
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div id="contentImgArea4">
								<img id="contentImg4" width="800" height="350"> 
							</div>
						</td>
					</tr>
					<tr>
