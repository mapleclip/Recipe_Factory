...
<head>
<meta charset="UTF-8">
<title>공지사항 - <%= notice.getNoticeTitle() %></title>
<style type="text/css">
/* 	section */
.section-area {
	width: 1000px;
	...
	<div class="outline">
		...
		<section>
			<div class="outer">
				...
				<br>
				<div class="tableArea">
					<form action="noticeUpdateForm.no" id="detailForm"
						...
						<table class="board_list">
							...
							<tbody>
								...
								<tr>
									...
									<td class="sel_op"><input type="hidden" name = "no" value ="<%= notice.getNoticeNo() %>"><%= notice.getNoticeTitle() %></td>
								</tr>
								<tr>
									<th class="input_txt">작성자</th>
									<td class="sel_op"><%= notice.getNoticeWriter() %></td>
								</tr>

								<tr>
									<th class="input_txt">작성일</th>
									<td class="sel_op"><%= notice.getNoticeDate() %></td>
								</tr>
								<tr>
											...
											<div class="inner_qnaNotice">
												<div class="notice_qna">
													...
													<textarea name="content"
														...
														cols="10" rows="10" readonly="readonly"><%= notice.getNoticeContent() %></textarea>
												</div>
											</div>
										</div>
									</td>
						...
						<div align="center">
							<% if (loginUser != null && loginUser.getMemberid().equals(notice.getNoticeWriter())) { %>
