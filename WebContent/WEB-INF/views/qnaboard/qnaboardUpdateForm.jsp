...
<%
	QnaBoard qb = (QnaBoard)request.getAttribute("qb");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="outline">
		...
		<section>
			<div class="outer">
				...
				<br>
				<div class="tableArea">
					<form action="qboardUpdate.qb" id="detailForm"
							...
							<tbody>
								...
								<tr>
									...
									<td class="sel_op">
										...
										<input type ="text" name="title" value="<%= qb.getQboard_title() %>">
									</td>
								</tr>
								<tr>
											...
											<div class="inner_qnaNotice">
												<div class="notice_qna">
													...
													<textarea name="content"
														...
														cols="20" rows="10"><%= qb.getQboard_content() %></textarea>
												</div>
											</div>
										</div>
									</td>
	...
	<script>
		function deleteNotice(){
			...
			if(bool){
				location.href="<%=request.getContextPath()%>/delete.no?no="+<%=qb.getQboardNo()%>;
			}
		}
	</script>
