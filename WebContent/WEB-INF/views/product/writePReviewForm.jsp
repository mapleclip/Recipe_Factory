...
<body>
	...
	<div class="outer">
		...
		<div class="tableArea">
			<form action="<%= request.getContextPath() %>/writeReview.pr" method="post">
				<input type="hidden" name="pId" value="<%= pId %>">
				<table>
					<tr>
						<th>제목</th>
						<td colspan="3"><input type="text" size="58" name="rTitle"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td colspan="3">
							<textarea rows="15" cols="60" name="rContent" style="resize:none;"></textarea>
						</td>
					</tr>
				</table>
				<br>
